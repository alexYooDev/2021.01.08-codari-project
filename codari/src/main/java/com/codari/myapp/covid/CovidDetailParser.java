	...
	public List<CovidDetailVO> getCovidDetail() {
		...
		try {
			while (true) {
				...
				String url = "http://openapi.data.go.kr/openapi/service/rest/Covid19/getCovid19SidoInfStateJson?serviceKey=euX6vFhPLUxGCkMSRoTlyG4Dwdy%2BP%2BHjEiRR5hCNLSd6L87ZLNyZb50xq8PXcYK3cOCC2r2SH4i7DFbRZTElAg%3D%3D&numOfRows=10&startCreateDt="
						+ today + "&endCreateDt=" + today + "&pageNo=" + page;
