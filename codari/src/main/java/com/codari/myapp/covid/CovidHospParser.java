...
public class CovidHospParser {
	...
	public List<CovidHospVO> getHospInfo() {
		...
		try {
			while (true) {
				String url = "http://apis.data.go.kr/B551182/pubReliefHospService/getpubReliefHospList?serviceKey=lycEChYp17HBUpubmIggfvsSVH4hNI7Hnx1%2FzJk0L5ux02t%2FxJcg6EWrWWagsx3Z45wyalba2x9XAMlfvNKmdg%3D%3D&numOfRows=145&spclAdmTyCd=A0&pageNo="
						+ page;
