...
public class CovidHospParser3 {
	...
	public List<CovidHospVO> getHospInfo3() {
		...
		try {
			while (true) {
				String url = "http://apis.data.go.kr/B551182/pubReliefHospService/getpubReliefHospList?serviceKey=lycEChYp17HBUpubmIggfvsSVH4hNI7Hnx1%2FzJk0L5ux02t%2FxJcg6EWrWWagsx3Z45wyalba2x9XAMlfvNKmdg%3D%3D&numOfRows=100&spclAdmTyCd=97&pageNo="
						+ page;
